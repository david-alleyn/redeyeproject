...
unsigned int ShaderLoader::loadShader(const std::string & vertex_shader_file, const std::string & fragment_shader_file) {
...
unsigned int ShaderLoader::loadShader(const std::string & vertex_shader_file, const std::string & geometry_shader_file, const std::string & fragment_shader_file) {
...
unsigned int ShaderLoader::_createShader(const std::string & shader_file, GLenum shader_type) {
...
unsigned int ShaderLoader::_createProgram(const std::vector<unsigned int>& shader_objects) {
